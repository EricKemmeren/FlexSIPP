...
#         path = g.construct_path(move, current_agent=current_train, agent_velocity=measures["trainSpeed"])
#         moves_per_agent[trainNumber].append(path)
#         block_routes = convertMovesToBlock(moves_per_agent, g, current_train)
